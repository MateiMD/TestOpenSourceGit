...
Ext.define('Ext.field.Select', {
	...
	var flage=true;
		...
		var heightList;
		var count=3;
		var clsClass="x-list-label-employee";     //"x-list-label"; change class for reduce font size
		if(id == 'getEmployeeNameDatasField') {
		...
		}else if(this.getStore().getStoreId()=="PositionsSortOrder") {
				clsClass="x-list-label-employee";
					if(this.getStore().getData().length>3){
						count=this.getStore().getData().length;
					}
